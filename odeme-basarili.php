        ...
        <section class="hero-1" id="home">
            ...
            <div class="container">
                <div class="row align-items-center hero-content">
                    <div class="col-lg-6">
                        <h1 style="color:lightgreen">Tebrikler ! Ödeme başarılı</h1>
                        <h1 class="hero-title fw-bold mb-4 pb-3 text-white">Bakiyeniz İstanbulkart'ınıza tanımlanmıştır.
                        </h1>
                        
                            <button type="submit" class="btn btn-info form-btn">Tekrar Bakiye Yükle</button>
</form>
                    </div>
